  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-4 w-full">
            ...
            <div className="rainbow relative z-0 bg-[#0077b6]/15 overflow-hidden p-px flex items-center justify-center rounded-full transition duration-300 active:scale-100 mt-28 md:mt-32">
                <button className="flex items-center justify-center gap-3 pl-4 pr-6 py-3 text-white rounded-full font-medium bg-[#0077b6]/80 backdrop-blur">
                    ...
                    <span className='text-xs'>AI-Powered Resume Builder</span>
                </button>
            </div>
            ...
            <p className="text-sm md:text-base text-gray-300 bg-clip-text text-center max-w-lg mt-4.5 px-4">
                Create ATS-friendly resumes with AI, customize modern templates, and land more interviews with confidence.
            </p>
           ...
           <div className="flex gap-3 mt-8">
                {!user ? (
                    ...
                    <Link
                        to="/app/?state=register"
                        className="inline-flex items-center justify-center bg-[#0077b6] hover:bg-[#0096c7] text-white px-6 py-2.5 rounded-full text-sm transition cursor-pointer group"
                    >
                        <div className="relative overflow-hidden">
                        <span className="block transition-transform duration-200 group-hover:-translate-y-full">
                            Get Started today
                    ...
                    <div className="bg-white/15 hover:bg-white/10 p-px flex items-center justify-center rounded-full hover:scale-105 transition duration-300 active:scale-100">
                        <Link
                        to="/app/?state=login"
                        className="inline-flex items-center justify-center px-6 py-3 text-sm text-white rounded-full bg-white/5 cursor-pointer"
                        >
                        Login
                        </Link>
                    </div>
                    ...
                    <Link
                    to="/app"
                    className="group inline-flex items-center gap-2 px-7 py-3 bg-[#0077b6] hover:bg-[#0096c7] rounded-full text-white text-sm transition-all duration-300 hover:scale-105 active:scale-95"
                    >
                    <span>Dashboard</span>
