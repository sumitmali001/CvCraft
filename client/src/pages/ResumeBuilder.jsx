...
const changeResumeVisibility = async () => {
  ...
  return (
    <div className="        bg-black
        ...
        bg-center
        bg-no-repeat
        bg-fixed min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-6">
        <Link
          to="/app"
          className="inline-flex items-center gap-2 text-white hover:text-slate-200 transition-all"
        >
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <hr
                className="absolute top-0 left-0 h-1 bg-linear-to-r from-[#0077b6] to-[#0096c7] border-none transition-all duration-500"
                style={{
          ...
          <div className="space-y-6">
                ...
                onClick={()=>{
                  ...
                  className="bg-[#0077b6] text-white hover:bg-[#005f8f] transition-all rounded-md px-6 py-2 mt-6 text-sm shadow-sm"
                >
                  Save Changes
                </button>
            </div>
